...
Launches 9 SLURM Stage 1 micro-sim jobs (3 thresholds x 3 multipliers).
...
KILL_MULTIPLIERS = [1.0, 1.5, 2.0]
ABCB1_PRODUCTION_RATES = [0.0005, 0.001, 0.002]
FIXED_STRESS_THRESHOLD = 0.03  # Keep fixed at XML default
